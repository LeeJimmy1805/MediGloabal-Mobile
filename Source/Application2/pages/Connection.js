            ...
            <View style = {(styles.container)}>
                ...
                <View style={(styles.innerContainerWelcome)}>
                    ...
                    <View style={(styles.innerContainerWelcomeConnection)}>
                        <TouchableOpacity style={(styles.innerContainerWelcomeConnectionButton)} onPress={() => this.props.navigation.navigate('SignIn')}>
                        ...
                        <TouchableOpacity style={(styles.innerContainerWelcomeConnectionButton)} onPress={() => this.props.navigation.navigate('SignUp')}>
